...
namespace vrt {
	...
	public:
		vrt::bpLoop* Floops() const { return floops; }
	...
	public:
		...
		vrt::bpEdge* Edge() const { return edge; }

		vrt::bpLoop* Eloop() const { return eloop; }

		vrt::bpHalfEdge* Nxt() const { return nxt; }

		vrt::bpHalfEdge* Pev() const { return pev; }

		vrt::bpHalfEdge* Adj() const { return adj; }

		vrt::bpVertex* BeginVtx() const { return beginVtx; }
	private:
		bpEdge* edge = nullptr;
	...
	public:
		...
		vrt::bpHalfEdge* FirstEdge() const { return firstEdge; }
	private:
		Point3f coord;
